...
<h2>Try it</h2>
<pre>curl '<span class="this-worker-url">https://your-deployed-url.com</span>/v1/intensity?zone=FR' \\
...
<p>
  ...
  allowlist - see the <a href="#api-reference">API reference</a> below for the full contract.
</p>
